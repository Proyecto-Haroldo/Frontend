...
function Services() {
  ...
  return (
      <div className="mx-auto max-w-4xl w-full space-y-6 md:space-y-8">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <button
                ...
                className="flex flex-col items-center p-6 md:p-8 bg-white rounded-xl shadow-sm"
              >
                <Users className="h-12 w-12 md:h-16 md:w-16 text-light-purple mb-4" />
              ...
              <button
                ...
                className="flex flex-col items-center p-6 md:p-8 bg-white rounded-xl shadow-sm"
              >
                <Building2 className="h-12 w-12 md:h-16 md:w-16 text-light-purple mb-4" />
